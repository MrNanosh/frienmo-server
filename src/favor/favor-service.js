...
const FavorService = {
  ...
  serializeFavor(favor) {
    return {
      ...
      description: xss(favor.description),
      user_location: xss(favor.user_location),
      tags: xss(favor.tags),
      limit: favor.limit
    };
  },
  ...
  getFavorByFriends(db, user_id, productsPerPage, page) {
    //excludes personal
    const offset = productsPerPage * (page - 1);
    ...
    return db("outstanding as o")
      ...
      .leftOuterJoin("friend as fr", function() {
        this.on("fr.user_id", "=", "o.users_id").orOn(
          "fr.friend_id",
          "=",
          "o.receiver_id"
        );
  ...
  getPersonalFavors(db, user_id, productsPerPage, page) {
    ...
    return db("outstanding as o")
      ...
      .leftOuterJoin("friend as fr", function() {
        this.on("o.users_id", "=", "fr.user_id").orOn(
          "fr.friend_id",
          "=",
          "o.receiver_id"
        );
  ...
  getPublicFavors(db, user_id, productsPerPage, page) {
    const offset = productsPerPage * (page - 1);
    return db("outstanding as o")
      .join("favor as fa", "fa.id", "=", "o.favor_id")
      .join("user as creator", "creator.id", "=", "fa.creator_id")
  ...
  updateOutstanding(db, favor_id, users_id, receiver_id) {
    return db
      .from("outstanding")
